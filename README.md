...
Classe IXCTCPDF método _destroy(): Alterado logica do método. Ele utilizava opendir, readdir e closedir para ler o diretório da /tmp/ e deletar os PDFs ali criado. Lógica alterada para não utilizar mais readdir e sim utilizar scandir para a busca de arquivos ficar mais leve.